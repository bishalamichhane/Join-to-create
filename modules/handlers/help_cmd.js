  ...
  if (!args[0])
    return message.reply({
      embeds: [new Discord.MessageEmbed()
        ...
        .setDescription(`PREFIX: \`${prefix}\` | [Click here - Tutorial Video](https://youtu.be/zNE8insVgOA)\n\n*Enter the right Category, to see help for them* Example: \`${prefix}help voice\`\n[\`INVITE ME\`](https://discord.com/api/oauth2/authorize?client_id=${client.user.id}&permissions=8&scope=bot) | [\`Support Server\`](https://discord.gg/sKFSzEbR2x) | [\`Website\`](https://Bishal1) | Developer: \`Bishal1#5223\``)
    ...
    case "general": {
      return message.reply({
        embeds: [new Discord.MessageEmbed()
          ...
          .addField(`\`${prefix}support\``, "> *Sends you a Link for the [SUPPORT SERVER](https://discord.gg/sKFSzEbR2x) of the Bot!*", true)
