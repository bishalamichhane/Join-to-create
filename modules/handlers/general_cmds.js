    ...
    message.reply({
      embeds: [
        new Discord.MessageEmbed()
          .setColor(ee.color)
          .setFooter(ee.footertext, ee.footericon)
          .setAuthor(`${client.user.username} Support`, client.user.displayAvatarURL(), "https://Bishal1")
          .setDescription("[\`Join to Support Server\`](https://discord.gg/sKFSzEbR2x) to gain help!")
      ]
    })
    return;
    ...
    cpuStat.usagePercent(function (e, percent, seconds) {
      try {
        ...
        const botinfo = new Discord.MessageEmbed()
          ...
          .setFooter("Coded by:    Bishal1#5223");
    ...
    message.reply({
      embeds: [
        new Discord.MessageEmbed()
          .setColor(ee.color)
          .setFooter(ee.footertext, ee.footericon)
          .setAuthor(`${client.user.username}'s' Source Code`, client.user.displayAvatarURL(), "https://Bishal1")
          .setTitle(`This Bot is made by \`Bishal1#5223\` and **this** is the Source Code link to this Bot`)
          .setURL("")
          ...
          .addField("Source Code. ", "Don't just use the source for yourself,... please [invite](https://discord.com/api/oauth2/authorize?client_id=${client.user.id}&permissions=8&scope=bot) me too!")
